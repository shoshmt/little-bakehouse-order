...
const PRODUCTS = [
  ...
  // חדש: וופל בלגי מחמצת (חלבי) — חבילה של 4
  // חשוב: להעלות תמונה בשם waffle-belgian.jpg
  { id:"waffle_belgian", name:"וופל בלגי מחמצת (חבילה של 4)", price:60, img:"waffle-belgian.jpg", kind:"pastry", tags:["חלבי"] },
];
...
const MUFFIN_GROUPS = [
  {
    ...
    options: [
      ...
      { id:"muffin_vanilla",     label:"מאפינס וניל־אספרסו",      price:12 },
      { id:"muffin_strawberry",  label:"מאפינס תות (בעונה)",      price:12 },
      { id:"muffin_blueberry",   label:"מאפינס אוכמניות (בעונה)", price:12 },
    ]
  },
  {
    id: "muffins_nosugar",
    ...
    options: [
      ...
      { id:"muffin_strawberry_sf",  label:"מאפינס תות ללא סוכר (בעונה)",     price:15 },
      { id:"muffin_blueberry_sf",   label:"מאפינס אוכמניות ללא סוכר (בעונה)",price:15 },
    ]
  }
];
...
const WORKSHOPS = [
  {
    ...
    desc:"ערב זוגי מלא אווירה: מכינים פיצות מחמצת בטאבון, יוצרים כיכר לחם מחמצת, ומבינים צעד-צעד את עולם המחמצת — מההאכלה ועד האפייה."
  },
  {
    id:"ws_group",
...
function renderTags(tags){
  ...
  const chips = tags.map(t => {
    const cls = (t === "חלבי") ? "tag dairy" : "tag";
