...
function renderRollsMix(){
  ...
  const card = document.createElement("div");
  card.className = "card";   // ✅ אותו גודל כמו כולם
  card.innerHTML = `
    ...
    <div class="row" style="margin-bottom:10px;">
      <div class="mini-label">בחירת קמח</div>
...
function renderMuffins(){
  ...
  card.innerHTML = `
    ...
    <div id="muffinLine" style="margin-top:10px;font-weight:800;color:#8c5a2b;">בחרי טעם</div>
  `;
  container.appendChild(card);
